...
namespace Assignment1_Checkpoint1
{
    ...
    "Address`, `FirstName`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            // oleDbSelectCommand4
            // 
            this.oleDbSelectCommand4.CommandText = "SELECT EventID, EventName, ArenaID, Status, Capacity, EventDate\r\nFROM  EVENT\r\nORD" +
    "ER BY EventID";
            this.oleDbSelectCommand4.Connection = this.ctnNZST;
            // 
            // oleDbInsertCommand4
            // 
            this.oleDbInsertCommand4.CommandText = "INSERT INTO `EVENT` (`EventName`, `ArenaID`, `Status`, `Capacity`, `EventDate`) V" +
    "ALUES (?, ?, ?, ?, ?)";
            ...
            // daEvent
            // 
            this.daEvent.DeleteCommand = this.oleDbDeleteCommand4;
            this.daEvent.InsertCommand = this.oleDbInsertCommand4;
            this.daEvent.SelectCommand = this.oleDbSelectCommand4;
            ...
            this.daEvent.UpdateCommand = this.oleDbUpdateCommand4;
            // 
            // oleDbSelectCommand5
            // 
            this.oleDbSelectCommand5.CommandText = "SELECT ChallengeID, CompetitorID, Status\r\nFROM  ENTRY\r\nORDER BY ChallengeID, Comp" +
    "etitorID";
            this.oleDbSelectCommand5.Connection = this.ctnNZST;
            // 
            // oleDbInsertCommand5
            // 
            this.oleDbInsertCommand5.CommandText = "INSERT INTO `ENTRY` (`ChallengeID`, `CompetitorID`, `Status`) VALUES (?, ?, ?)";
            ...
            // oleDbUpdateCommand5
            // 
            this.oleDbUpdateCommand5.CommandText = "UPDATE `ENTRY` SET `ChallengeID` = ?, `CompetitorID` = ?, `Status` = ? WHERE ((`C" +
    ...
    "`Status` = ?)))";
            ...
            // oleDbDeleteCommand5
            // 
            this.oleDbDeleteCommand5.CommandText = "DELETE FROM `ENTRY` WHERE ((`ChallengeID` = ?) AND (`CompetitorID` = ?) AND ((? =" +
    " 1 AND `Status` IS NULL) OR (`Status` = ?)))";
            ...
            // daEntry
            // 
            this.daEntry.DeleteCommand = this.oleDbDeleteCommand5;
            this.daEntry.InsertCommand = this.oleDbInsertCommand5;
            this.daEntry.SelectCommand = this.oleDbSelectCommand5;
            ...
            new System.Data.Common.DataTableMapping("Table", "ENTRY", new System.Data.Common.DataColumnMapping[] {
                        ...
                        new System.Data.Common.DataColumnMapping("CompetitorID", "CompetitorID"),
                        new System.Data.Common.DataColumnMapping("Status", "Status")})});
            this.daEntry.UpdateCommand = this.oleDbUpdateCommand5;
            // 
            // dsNZST
            // 
        ...
        private OleDbDataAdapter daChallenge;
        ...
        private OleDbDataAdapter daCompetitor;
        ...
        private OleDbDataAdapter daEvent;
        ...
        private OleDbDataAdapter daEntry;
